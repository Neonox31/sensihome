...
(function (log, err, exit) {
    ...
    /** Init logger **/
    this.sensihome.logger = new (winston.Logger)({
        transports: [
            ...
            new (winston.transports.File)({
                filename: this.sensihome.config.get('logger:file:path'),
                handleExceptions: true,
                humanReadableUnhandledException: true,
                json: false
            })
    ...
    this.sensihome.database.connect(this.sensihome.config.get("db:uri"));
